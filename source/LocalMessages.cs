...
namespace CodexStrip {
 ...
 public sealed class LocalMessages {
  ...
  public bool Waiting(Card c){lock(tails){Tail t;return c.Status!="completed"&&c.Status!="idle"&&c.Status!="interrupted"&&c.Status!="failed"&&tails.TryGetValue(c.Id,out t)&&t.Question.Length>0;}}
